...
function wp-setup () {
  ...
  mv $HOME/gitpod-wordpress/.gitpod/launch.json ${GITPOD_REPO_ROOT}/.theia/launch.json
  ...
  cp $HOME/gitpod-wordpress/.gitpod/wp-config.php ${GITPOD_REPO_ROOT}/${APACHE_DOCROOT}/wp-config.php
  wp core install \
